...
from Ticket.models import TicketsMasterConfiguration, Entity
...
#     entities_id = models.ForeignKey(
#         Entity, on_delete=models.SET_NULL, null=True, blank=True, related_name='users',db_column='entities_id' 
#     )
#     locations = models.ForeignKey(
#         TicketsMasterConfiguration, on_delete=models.SET_NULL, null=True, blank=True,
#         related_name='users_locations', limit_choices_to={'field_type': 'Location'},db_column='locations_id' 
#     )
#     force_password_change = models.BooleanField(default=False)
#     # department_id = models.ForeignKey(
#     #     TicketsMasterConfiguration, on_delete=models.SET_NULL, null=True, blank=True,
#     #     related_name='users_departments', limit_choices_to={'field_type': 'Department'}
#     # )
#     department_id = models.ForeignKey(
...
#         on_delete=models.CASCADE,
#         db_column="users_id",  # ✅ map to DB column name
#         related_name="emails"
#     )
...
#     class Meta:
#         db_table = "useremails"   # ✅ set table name if DB already has one
#         managed = True          # if Django should manage migrations

#     def __str__(self):
#         return f" {self.id} - {self.email or 'No Email'}"